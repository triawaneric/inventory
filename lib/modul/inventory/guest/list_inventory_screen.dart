...
class ListGuestInventory extends StatefulWidget{
  const ListGuestInventory({super.key});

  @override
  State<StatefulWidget> createState() {
    return _ListGuestInventory();
  }

}

class _ListGuestInventory extends State<ListGuestInventory>{
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => DetailGuestInventory(product:item,))).then((value) {
                      setState(() {
                        // refresh state
                        getdata();
                      });
