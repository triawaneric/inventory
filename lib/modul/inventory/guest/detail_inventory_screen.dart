...
class DetailGuestInventory extends StatefulWidget{
  DetailGuestInventory({required this.product,super.key});

  Product product;

  @override
  State<StatefulWidget> createState() {
    return _DetailGuestInventory();
  }

}

class _DetailGuestInventory extends State<DetailGuestInventory>{
